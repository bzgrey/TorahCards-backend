...
content_id: b8c212b6d0857cb1be2089085cb58a07b27781914bdc2ccccad9c8d989836ebb
---

# file:`src/Notes/NotesConcept.ts`
...
export default class NotesConcept {
  ...
  constructor(private readonly db: Db) {
    ...
    // Ensure uniqueness for , name) pair to prevent duplicate notes
