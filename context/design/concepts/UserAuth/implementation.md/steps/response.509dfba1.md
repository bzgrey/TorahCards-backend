---
timestamp: 'Mon Oct 20 2025 17:09:21 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251020_170921.04b31ddb.md]]'
content_id: 509dfba18c605ba83c161b595bc6cc246d3c731e6863dca4096521ca94ecfeb8
---
...
export default class UserAuthConcept {
  ...
  async _getUsername(
    ...
    const foundUsers = await this.users.find({ _id: { $in: userIds } }).toArray();
